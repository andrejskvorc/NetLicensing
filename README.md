...
For now plan is to rework, so users can choose to you Bouncy Castle or [System.Security.Cryptography.Cng](https://www.nuget.org/packages/System.Security.Cryptography.Cng/), upgrade everything to Net 8, Visual Studio 2022. 
